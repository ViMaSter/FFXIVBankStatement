...
>
> ![image](https://github.com/goatcorp/BankStatement/assets/16760685/d9732094-e1ed-4769-a70b-58ed2b92580c)
...
[new-repo]: https://github.com/new?template_name=BankStatement&template_owner=goatcorp
...
Basically, just replace all references to `BankStatement` in all of the files and filenames with your desired name, then start building the plugin of your dreams. You'll figure it out 😁

Dalamud will load the JSON file (by default, `BankStatement/BankStatement.json`) next to your DLL and use it for metadata, including the description for your plugin in the Plugin Installer. Make sure to update this with information relevant to _your_ plugin!
